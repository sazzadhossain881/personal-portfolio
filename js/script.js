...
//we need to validate if the user has previously chose a topic
...
//Activate or Deactivate the button manually with the buttons

themeButton.addEventListener('click', () => {
    //Add  or Remove the dark/light icon ---icon theme
    document.body.classList.toggle(darkTheme)
    themeButton.classList.toggle(iconTheme)
    //we save the theme and current icon that the user has choose
...
function linkAction() {
    const navMenu = document.getElementById('nav-menu');
    //when we click the menu__links we remove the show menu
    navMenu.classList.remove('show-menu');
}
